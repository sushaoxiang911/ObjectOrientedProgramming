...
Ship::Ship(const std::string& name_, Point position_, double fuel_capacity_,
            ...
            :Sim_object(name_), Track_base(position_), fuel_capacity(fuel_capacity_),
...
void Ship::set_destination_position_and_speed(Point destination_position, double speed)
{
    ...
    set_course(current_compass_vector.direction);
    set_speed(speed);
...
void Ship::set_load_destination(Island * island_ptr)
{
    throw Error("Cannot load at a destination!");
}

void Ship::set_unload_destination(Island * island_ptr)
{
